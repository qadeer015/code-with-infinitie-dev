            ...
            (function(global) {
                (function() {
                    ...
                    function m(t, e) {
                        var s = arguments;
                        void 0 === e && (e = !1);
                        for (var i = [], n = 2; n < arguments.length; n++) i[n - 2] = s[n];
                        return null != t && (e ? !!i.some(function(e) {
                            if ("Element" === e) return 1 === t.nodeType || "string" == typeof t.nodeName && "#text" !== t.nodeName && "#comment" !== t.nodeName || t.tagName && "string" == typeof t.tagName || t.setAttribute && "function" == typeof t.setAttribute;
                            if ("Text" === e) return 3 === t.nodeType || "#text" === t.nodeName;
                            if ("Comment" === e) return 8 === t.nodeType || "#comment" === t.nodeName;
                    ...
                    function v(t, e, s) {
                        ...
                        switch (o) {
                            case s._const.addAttribute:
                                if (!i || !m(i, s.simplifiedElementCheck, "Element")) return !1;
                                i.setAttribute(e[s._const.name], e[s._const.value]);
                                break;
                            case s._const.modifyAttribute:
                                if (!i || !m(i, s.simplifiedElementCheck, "Element")) return !1;
                                i.setAttribute(e[s._const.name], e[s._const.newValue]), m(i, s.simplifiedElementCheck, "HTMLInputElement") && "value" === e[s._const.name] && (i.value = e[s._const.newValue]);
                                break;
                            ...
                            case s._const.modifyTextElement:
                                if (!i || !m(i, s.simplifiedElementCheck, "Text")) return !1;
                                s.textDiff(i, i.data, e[s._const.oldValue], e[s._const.newValue]), m(i.parentNode, s.simplifiedElementCheck, "HTMLTextAreaElement") && (i.parentNode.value = e[s._const.newValue]);
                                break;
                            ...
                            case s._const.modifyComment:
                                if (!i || !m(i, s.simplifiedElementCheck, "Comment")) return !1;
                            ...
                            case s._const.relocateGroup:
                                p([], new Array(e[s._const.groupLength])).map(function() {
                            ...
                            case s._const.addElement:
                                ...
                                if (!m(i = b(t, u), s.simplifiedElementCheck, "Element")) return !1;
                            ...
                            case s._const.removeTextElement:
                                ...
                                var h = i.parentNode;
                                h.removeChild(i), m(h, s.simplifiedElementCheck, "HTMLTextAreaElement") && (h.value = "");
                                break;
                            case s._const.addTextElement:
                                ...
                                i.insertBefore(n, i.childNodes[c] || null), m(i.parentNode, s.simplifiedElementCheck, "HTMLTextAreaElement") && (i.parentNode.value = e[s._const.value]);
                                break;
                            default:
                            ...
                            ! function(t, e, s) {
                                switch (e[s._const.action]) {
                                    case s._const.addAttribute:
                                        ...
                                        break;
                                    case s._const.modifyAttribute:
                                        w(e, s._const.oldValue, s._const.newValue), v(t, e, s);
                                        break;
                                    case s._const.removeAttribute:
                    ...
                    var y = function(t) {
                        ...
                        C = function(t, e) {
                            for (var s = t.childNodes ? t.childNodes : [], i = e.childNodes ? e.childNodes : [], n = V(s.length, !1), a = V(i.length, !1), o = [], r = function() {
                                    ...
                                    var t = function(t, e, s, i) {
                                        ...
                                        for (var h = 0; h < o; h++)
                                            for (var u = t[h], f = 0; f < r; f++) {
                                                var m = e[f];
                                                s[h] || i[f] || !O(u, m, d, c) ? l[h + 1][f + 1] = 0 : (l[h + 1][f + 1] = l[h][f] ? l[h][f] + 1 : 1, l[h + 1][f + 1] >= n && (n = l[h + 1][f + 1], a = [h + 1, f + 1]))
                                            }
                                        return 0 !== n && {
                                            oldValue: a[0] - n,
                                            newValue: a[1] - n,
                                    ...
                                    t ? (o.push(t), p([], new Array(t.length)).map(r).forEach(function(e) {
                            ...
                            ! function(t, e, s) {
                                ...
                                switch (e[s._const.action]) {
                                    ...
                                    case s._const.addElement:
                                        ...
                                        n = null === (i = $(t, d)) || void 0 === i ? void 0 : i.node, l = N(e[s._const.element]), n.childNodes || (n.childNodes = []), u >= n.childNodes.length ? n.childNodes.push(l) : n.childNodes.splice(u, 0, l), n.subsets && n.subsets.forEach(function(t) {
                    ...
                    function T(t, e) {
                        ...
                        if (m(t, e.simplifiedElementCheck, "Text", "Comment")) s.data = t.data;
                        else {
                            ...
                            e.valueDiffing && (m(t, e.simplifiedElementCheck, "HTMLTextAreaElement") && (s.value = t.value), m(t, e.simplifiedElementCheck, "HTMLInputElement") && ["radio", "checkbox"].includes(t.type.toLowerCase()) && void 0 !== t.checked ? s.checked = t.checked : m(t, e.simplifiedElementCheck, "HTMLButtonElement", "HTMLDataElement", "HTMLInputElement", "HTMLLIElement", "HTMLMeterElement", "HTMLOptionElement", "HTMLProgressElement", "HTMLParamElement") && (s.value = t.value), m(t, e.simplifiedElementCheck, "HTMLOptionElement") && (s.selected = t.selected))
                        }
                        return s
                    }
                        ...
                        Y = function() {
                            ...
                            return t.prototype.init = function() {
                                ...
                                do {
                                    ...
                                    0 === (s = this.findNextDiff(t, e, [])).length && (E(t, e) || (this.foundAll ? console.error("Could not find remaining diffs!") : (this.foundAll = !0, D(t), s = this.findNextDiff(t, e, [])))), s.length > 0 && (this.foundAll = !1, this.tracker.add(s), S(t, s, this.options))
                                } while (s.length > 0);
                                ...
                                if (t.nodeName !== e.nodeName) {
                                    ...
                                    return [(new f).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, N(t)).setValue(this.options._const.newValue, N(e)).setValue(this.options._const.route, s)]
                                }
                                if (s.length && this.options.diffcap < Math.abs((t.childNodes || []).length - (e.childNodes || []).length)) return [(new f).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, N(t)).setValue(this.options._const.newValue, N(e)).setValue(this.options._const.route, s)];
                                ...
                                for (var a, o, r, l, d, c = function(t, e, s) {
                                    ...
                                    }(t, e, s), h = c.gaps1, u = c.gaps2, p = t.childNodes.slice(), m = e.childNodes.slice(), g = Math.min(h.length, u.length), b = [], v = 0, w = 0; v < g; w += 1, v += 1)
                                    if (!n || !0 !== h[v] && !0 !== u[v]) {
                                        if (!0 === h[w])
                                            if ("#text" === (l = p[w]).nodeName)
                                                if ("#text" === m[v].nodeName) {
                                                    if (l.data !== m[v].data) {
                                                        ...
                                                        d || b.push((new f).setValue(this.options._const.action, this.options._const.modifyTextElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.oldValue, l.data).setValue(this.options._const.newValue, m[v].data))
                                                    }
                                                } else b.push((new f).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.value, l.data)), h.splice(w, 1), p.splice(w, 1), g = Math.min(h.length, u.length), w -= 1, v -= 1;
                                        else !0 === u[v] ? b.push((new f).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, N(l)).setValue(this.options._const.newValue, N(m[v])).setValue(this.options._const.route, i.concat(w))) : (b.push((new f).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.element, N(l))), h.splice(w, 1), p.splice(w, 1), g = Math.min(h.length, u.length), w -= 1, v -= 1);
                                        else if (!0 === u[v]) "#text" === (l = m[v]).nodeName ? (b.push((new f).setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.value, l.data)), h.splice(w, 0, !0), p.splice(w, 0, {
                                            nodeName: "#text",
                                            data: l.data
                                        }), g = Math.min(h.length, u.length)) : (b.push((new f).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.element, N(l))), h.splice(w, 0, !0), p.splice(w, 0, N(l)), g = Math.min(h.length, u.length));
                                        else if (h[w] !== u[v]) {
                                            if (b.length > 0) return b;
                                            if (r = s[h[w]], (o = Math.min(r.newValue, p.length - r.length)) !== r.oldValue && o > -1) {
                                                a = !1;
                                                for (var y = 0; y < r.length; y += 1) O(p[o + y], p[r.oldValue + y], {}, !1, !0) || (a = !0);
                    ...
                    const q = (t, e, s, {
                            ...
                            childNodes: t.map((t, n) => {
                                ...
                                if (l.hidden || "true" === t.attributes ? .["data-colspan-placeholder"]) return;
                                const u = t.attributes ? { ...t.attributes
                                } : {};
                                if (l.sortable && o && (!r.length || h) && (l.filter ? u["data-filterable"] = "true" : u["data-sortable"] = "true"), l.headerClass && (u.class = c(u.class, l.headerClass)), s.sort && s.sort.column === n) {
                                    const t = "asc" === s.sort.dir ? i.ascending : i.descending;
                                    u.class = c(u.class, t), u["aria-sort"] = "asc" === s.sort.dir ? "ascending" : "descending"
                                } else s.filters[n] && (u.class = c(u.class, i.filterActive));
                                if (s.widths[n] && !d) {
                                ...
                                return {
                                    nodeName: "TH",
                                    attributes: u,
                                    childNodes: !a && !r.length || h ? l.sortable && o ? [{
                                        nodeName: "BUTTON",
                                        attributes: {
                        ...
                        B = (t, e, s, i, a, o, {
                                    ...
                                    childNodes: s.map(({
                                        ...
                                        const s = {
                                            ...
                                            childNodes: t.cells.map((t, s) => {
                                                ...
                                                if (o.hidden || "true" === t.attributes ? .["data-colspan-placeholder"]) return;
                                                if ("true" === t.attributes ? .["data-rowspan-placeholder"]) return;
                                                const r = {
                                                    nodeName: "TD",
                            ...
                            if (M.attributes.class = c(M.attributes.class, r.table), d || h || _) {
                                const t = q(e, i, a, {
                                    classes: r,
                                    hiddenHeader: l,
                                    sortable: p,
                            ...
                            return y.forEach(t => M.childNodes.push(t)), x.forEach(t => M.childNodes.push(t)), !1 !== b && (M.attributes.tabindex = String(b)), M
                        };
                    ...
                    var U = {
                        ...
                        J = z(U.exports = function() {
                            ...
                            var E = function() {
                                    ...
                                    return b.parse = function(t) {
                                        ...
                                        var s = this,
                                            ...
                                            c = N.p(t),
                                            p = function(t, e) {
                                                var n = N.w(s.$u ? Date.UTC(s.$y, e, t) : new Date(s.$y, e, t), s);
                                                return i ? n : n.endOf(r)
                                            },
                                            f = function(t, e) {
                                                return N.w(s.toDate()[t].apply(s.toDate("s"), (i ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(e)), s)
                                            },
                                            m = this.$W,
                                            g = this.$M,
                                            b = this.$D,
                                        ...
                                        var f = N.p(c),
                                            m = function(t) {
                                                var e = D(p);
                                                return N.w(e.date(e.date() + Math.round(t * i)), p)
                                            };
                            ...
                            }, D.locale = M, D.isDayjs = x, D.unix = function(t) {
                                return D(1e3 * t)
                                ...
                                i.parse = function(t) {
                                    ...
                                    if ("string" == typeof r) {
                                        var l = !0 === a[2],
                                            ...
                                            c = l || d,
                                            h = a[2];
                                        d && (h = a[2]), o = this.$locale(), !l && h && (o = s.Ls[h]), this.$d = function(t, e, s, i) {
                                            try {
                                                ...
                                                var w, _ = l || 0,
                                                    ...
                                                    x = c || 0,
                                                    M = h || 0;
                                                return u ? new Date(Date.UTC(b, v, g, _, y, x, M + 60 * u.offset * 1e3)) : s ? new Date(Date.UTC(b, v, g, _, y, x, M)) : (w = new Date(b, v, g, _, y, x, M), f && (w = i(w).week(f).toDate()), w)
                                            } catch (t) {
                                                return new Date("")
                                            }
                                        }(e, r, i, s), this.init(), h && !0 !== h && (this.$L = this.locale(h).$L), c && e != this.format(r) && (this.$d = new Date("")), o = {}
                    ...
                    const X = (t, e) => {
                        ...
                        Z = (t, e) => {
                            ...
                            if (t ? .constructor === Object && Object.prototype.hasOwnProperty.call(t, "data") && !Object.keys(t).find(t => !["text", "order", "data", "attributes"].includes(t))) {
                                const e = t;
                                if (n = e.data, a = e.attributes, void 0 !== e.text && void 0 !== e.order) return e;
                                s = {
                                    data: e.data,
                                    text: e.text,
                                    order: e.order,
                            ...
                            if (void 0 === s.text || void 0 === s.order) switch (e.type) {
                                case "string":
                                    "string" != typeof n && (s.text = s.text ? ? String(s.data), s.order = s.order ? ? s.text);
                                    break;
                                case "date":
                                    e.format && (s.order = s.order ? ? X(String(s.data), e.format));
                                    break;
                                case "number":
                                    s.text = s.text ? ? String(s.data), s.data = parseFloat(s.data), s.order = s.order ? ? s.data;
                                    break;
                                case "html":
                                    {
                                        const t = Array.isArray(s.data) ? {
                                            nodeName: "TD",
                                            childNodes: s.data
                                        } : I(`<td>${String(s.data)}</td>`);s.data = t.childNodes || [];
                                        const e = i(t);s.text = s.text ? ? e,
                                        s.order = s.order ? ? e;
                                        break
                                    }
                                case "boolean":
                                    "string" == typeof s.data && (s.data = s.data.toLowerCase().trim()), s.data = !["false", !1, null, void 0, 0].includes(s.data), s.order = s.order ? ? (s.data ? 1 : 0), s.text = s.text ? ? String(s.data);
                                    break;
                                case "other":
                        ...
                        G = (t, e) => {
                            ...
                            switch (e.type) {
                                ...
                                case "number":
                                    {
                                        const e = parseFloat(t.innerText);s = {
                                            data: e,
                                            order: e,
                                            text: t.innerText
                                        };
                        ...
                        K = t => {
                            if (t instanceof Object && t.constructor === Object && t.hasOwnProperty("data")) {
                                const e = t;
                                return "string" == typeof e.data && (e.text || (e.text = e.data), e.type || (e.type = "string")), e
                            }
                            const e = {
                                data: t
                            };
                        ...
                        tt = (t, e = void 0, s, n, a) => {
                            ...
                            if (t.headings) {
                                ...
                                Array.from(e.tHead.querySelectorAll("th")).forEach(t => {
                                    ...
                                    for (let i = 0; i < e; i++) {
                                        ...
                                        const e = s[r];
                                        0 === i && ("false" !== t.dataset.sortable ? .trim().toLowerCase() && "false" !== t.dataset.sort ? .trim().toLowerCase() || (e.sortable = !1), "false" === t.dataset.searchable ? .trim().toLowerCase() && (e.searchable = !1), "true" !== t.dataset.hidden ? .trim().toLowerCase() && "true" !== t.getAttribute("hidden") ? .trim().toLowerCase() || (e.hidden = !0), t.dataset.type && ["number", "string", "html", "date", "boolean", "other"].includes(t.dataset.type) && (e.type = t.dataset.type, "date" === e.type && t.dataset.format && (e.format = t.dataset.format))), r++
                                    }
                                })
                            ...
                            } else e ? .tBodies.length && (o.headings = Array.from(e.tBodies[0].rows[0].cells).map(t => K("")));
                            ...
                            if (t.data) {
                                ...
                                o.data = t.data.map((t, n) => {
                                    let a, r;
                                    Array.isArray(t) ? (a = {}, r = t) : t.hasOwnProperty("cells") && Object.keys(t).every(t => ["cells", "attributes"].includes(t)) ? (a = t.attributes, r = t.cells) : (a = {}, r = [], Object.entries(t).forEach(([t, s]) => {
                                        const i = e.indexOf(t);
                                        i > -1 && (r[i] = s)
                                    }));
                                    const l = [];
                                    ...
                                    for (; d < o.headings.length;)
                                        if (i.has(d)) {
                                            ...
                                            }), t.remainingRows--, t.remainingRows <= 0 && i.delete(d), d++
                                        } else {
                                            if (!(c < r.length)) break; {
                                                const t = r[c],
                                                    e = Z(t, s[d]),
                                                ...
                                                l.push(e), a > 1 && i.set(d, {
                                                    remainingRows: a - 1,
                                                    cellData: e
                                                }), d++, c++;
                                                for (let t = 1; t < n; t++) l.push({
                                                    data: "",
                                                    text: "",
                                                    order: "",
                                                    attributes: {
                                ...
                                o.data = Array.from(e.tBodies[0].rows).map(e => {
                                    ...
                                    for (; n < o.headings.length;)
                                        if (t.has(n)) {
                                            ...
                                            }), e.remainingRows--, e.remainingRows <= 0 && t.delete(n), n++
                                        } else {
                                            if (!(a < l.length)) break; {
                                                const e = l[a],
                                                    o = parseInt(e.getAttribute("colspan") || "1", 10),
                                                    r = parseInt(e.getAttribute("rowspan") || "1", 10),
                                                    d = e.dataset.content ? Z(e.dataset.content, s[n]) : G(e, s[n]);
                                                e.dataset.order && (d.order = isNaN(parseFloat(e.dataset.order)) ? e.dataset.order : parseFloat(e.dataset.order)), i.push(d), r > 1 && t.set(n, {
                                                    remainingRows: r - 1,
                                                    cellData: d
                                                }), n++, a++;
                                                for (let t = 1; t < o; t++) i.push({
                                                    data: "",
                                                    text: "",
                                                    order: "",
                                                    attributes: {
                    ...
                    class st {
                        ...
                        add(t) {
                            ...
                            if (this.dt.data.headings = this.dt.data.headings.concat([K(t.heading)]), this.dt.data.data.forEach((e, s) => {
                        ...
                        sort(t, e = void 0, s = !1) {
                            ...
                            const a = !(!i || !["string", "html"].includes(i.type)) && new Intl.Collator(i.locale || this.dt.options.locale, {
                                    usage: "sort",
                            ...
                            this.dt.data.data.forEach((t, e) => {
                                if (t.cells.some(t => "true" === t.attributes ? .["data-rowspan-placeholder"])) {
                                    ...
                                    if (t.cells.some(t => t.attributes ? .rowspan && parseInt(t.attributes.rowspan, 10) > 1)) {
                                        const t = o.length;
                                        o.push([e]), r.set(e, t)
                                    } else {
                                        const t = o.length;
                                ...
                                const o = (t, e) => {
                                    ...
                                    if ("true" === s.attributes ? .["data-rowspan-placeholder"]) {
                                        for (let s = t - 1; s >= 0; s--) {
                                            ...
                                            if ("true" !== t.attributes ? .["data-rowspan-placeholder"]) return t.order ? ? n(t)
                                        }
                                        return ""
                                    }
                                    return s.order ? ? n(s)
                                ...
                                return a && "number" != typeof r && "number" != typeof l ? a.compare(String(r), String(l)) : r < l ? -1 : r > l ? 1 : 0
                            });
                            const l = [];
                            o.forEach(t => {
                                t.forEach(t => {
                            ...
                            }), this.dt.data.data = l, this._state.sort = {
                                column: t,
                                dir: e
                    ...
                    const it = {
                        ...
                        at = (t, e, s, i, n) => {
                            let a = [];
                            if (n.firstLast && a.push(nt(1, n.firstText, n)), n.nextPrev) {
                                const e = t ? 1 : s - 1;
                                a.push(nt(e, n.prevText, n, {
                                    hidden: t
                                }))
                            }
                            let o = [...Array(i).keys()].map(t => nt(t + 1, String(t + 1), n, {
                                active: t === s - 1
                            }));
                    ...
                    exports.DataTable = class {
                        ...
                        init() {
                            ...
                            this._virtualDOM = T(this.dom, this.options.diffDomOptions || {}), this._tableAttributes = { ...this._virtualDOM.attributes
                            ...
                            }), this.rows = new et(this), this.columns = new st(this), this.data = tt(this.options.data, this.dom, this.columns.settings, this.options.type, this.options.format), this._render(), setTimeout(() => {
                        ...
                        _renderPagers() {
                            ...
                            let t = at(this.onFirstPage, this.onLastPage, this._currentPage, this.totalPages, this.options);
                        ...
                        _renderSeparateHeader() {
                            ...
                            if (e.attributes.class ? .includes(this.options.classes.table) || (e.attributes.class = c(e.attributes.class, this.options.classes.table)), this.options.tableRender) {
                        ...
                        multiSearch(t, e = "search") {
                            ...
                            const i = s.map(t => this.columns.settings.map((e, s) => {
                                if (!e || e.hidden || !e.searchable || t.columns && !t.columns.includes(s)) return !1;
                                let i = t.terms;
                            ...
                            this.data.data.forEach((t, e) => {
                                const a = t.cells.map((t, s) => {
                                    ...
                                    if (r.length) {
                                        ...
                                        ["base", "accent"].includes(t) && (r = r.toLowerCase()), ["base", "case"].includes(t) && (r = r.normalize("NFD").replace(/\p{Diacritic}/gu, ""));
                                ...
                                i.every((e, i) => e.find((e, n) => {
                                    ...
                                    return r ? r(e, a[n], t, n, s[i].source) : e.find(t => a[n] ? .find(e => e ? .includes(t)))
                        ...
                        insert(e) {
                            ...
                            if (Array.isArray(e)) {
                                ...
                                e.forEach((e, i) => {
                                    ...
                                    Object.entries(e).forEach(([e, s]) => {
                                        const a = t.indexOf(e);
                                        a > -1 ? n[a] = Z(s, this.columns.settings[a]) : this.hasHeadings || this.hasRows || 0 !== i || (n[t.length] = Z(s, this.columns.settings[t.length]), t.push(e), this.data.headings.push(K(e)))
                                    }), s.push({
                                        cells: n
                                    })
                                })
                            ...
                            })) : this.data = tt(e, void 0, this.columns.settings, this.options.type, this.options.format));
                        ...
                        setMessage(t) {
                            ...
                            if (this._tableFooters.forEach(t => s.childNodes.push(t)), this._tableCaptions.forEach(t => s.childNodes.push(t)), s.attributes.class ? .includes(this.options.classes.table) || (s.attributes.class = c(s.attributes.class, this.options.classes.table)), this.options.tableRender) {
                        ...
                        const i = {
                            ...
                            o = e.data.headings.filter((t, e) => a(e)).map(t => {
                        ...
                        if (i.selection)
                            if (Array.isArray(i.selection)) {
                                l = [];
                                for (let t = 0; t < i.selection.length; t++) l = l.concat(e.pages[i.selection[t] - 1].map(t => t.row))
                            } else l = e.pages[i.selection - 1].map(t => t.row);
                        else l = e.data.data;
                        let d = [];
                        if (d[0] = o, d = d.concat(l.map(t => {
                                const e = [];
                                let s = 0,
                                    i = 0;
                                for (; i < t.cells.length;) {
                                    ...
                                    if (a(i))
                                        if (r.has(s)) {
                                            const t = r.get(s);
                                            e.push(t.cellText), t.remainingRows--, t.remainingRows <= 0 && r.delete(s), s++, i++
                                        } else if ("true" === o.attributes ? .["data-rowspan-placeholder"]) i++;
                                    else if ("true" === o.attributes ? .["data-colspan-placeholder"]) e.push(""), s++, i++;
                                    else {
